...
import { getAddress, checkAndHandleUserRejectionsMessage } from "../../scripts/wallet"
...
export default function Example(props) {
            ...
            if (!addr) {
                ...
                handleTransfer(
                    ...
                    if (data.success) {
                        ...
                        checkAndHandleUserRejectionsMessage(data.error, setError)
                    }
                    setSubmitting(false)
                    setLoading(false)
                })
    ...
    return (
        <div className={`modal w-[690px] ${props.example == "swap" ? "my-8" : "my-12"}`}>
            ...
            {props.example == "nft" && <NFTForm nft={props.nft} />}
            ...
            {props.example == "transfer" && (
                <TransferForm
                    ...
                    receiverTwitter={receiverTwitter}
                    setReceiverTwitter={setReceiverTwitter}
                />
            )}
            ...
            {props.example == "swap" && (
                <SwapForm
                    ...
                    setSwapExchange={setSwapExchange}
                    swapReceive={swapReceive}
                    setSwapReceive={setSwapReceive}
                    slippage={slippage}
