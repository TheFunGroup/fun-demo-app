            ...
            {!ready && (
                <div className="nftSelectModal w-[690px] mt-24">
                    ...
                    <div className="flex w-full justify-between items-center mt-12">
                        <div
                            className={`border-[1px] rounded-[12px] p-6 flex flex-col cursor-pointer ${
                                selected == 1 ? "border-[#2D4EA2] bg-[#2d4ea214]" : "border-[#E4E7EC]"
                            } `}
                        ...
                        <div
                            className={`border-[1px] rounded-[12px] p-6 flex flex-col cursor-pointer ${
                                selected == 2 ? "border-[#2D4EA2] bg-[#2d4ea214]" : "border-[#E4E7EC]"
                            }`}
