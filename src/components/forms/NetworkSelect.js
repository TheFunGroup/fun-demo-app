...
const getHighlightCSS = (sameNetwork, networkLength, index) => {
    ...
    console.log(index, networkLength)
...
export default function NetworkSelect(props) {
  ...
  return (
    <div
      ...
      ref={selectBtnRef}
    >
      <div className="text-[#344054] text-sm font-medium mb-[6px] cursor-pointer">
        {props.label}
      </div>
      <div
        className={`${
      ...
      >
        <div className="flex items-center cursor-pointer">
          ...
          <div className="text-[#101828] px-[14px] font-medium">
            {" "}
              ...
              >
                <div className="flex items-center cursor-pointer">
                  <Image
                    ...
                    alt=""
                  />
                  <div className="text-[#101828] px-[14px]">
