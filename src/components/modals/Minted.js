        ...
        <div className="modal w-[420px] my-24 flex flex-col items-center">
            <div className="flex items-center">
                ...
                <div
                    width="112"
                    height="112"
                    className="border-[4px] border-[#F2F6F7] minted flex items-center justify-center rounded-[20px] -ml-3">
            ...
            <div className="w-full button-dark p-3 font-medium text-center mt-12" onClick={() => router.push("/")}>
                Done
            </div>
        </div>
    )
