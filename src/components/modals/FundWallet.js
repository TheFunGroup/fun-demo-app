...
export default function FundWallet(props) {
    ...
    return (
        <div className="modal w-[512px] my-12">
            ...
            <div className="text-[#667085] text-sm mt-1 whitespace-nowrap">
                Add test network tokens to your wallet to complete transactions.
            </div>
            ...
            <div className="w-full flex items-center justify-center mt-4">
                <div className="w-[175px] text-center button p-3 font-medium text-[#344054] mr-3" onClick={() => router.push("/")}>
                    Cancel
                </div>
                ...
                <div
                    ...
                    {funding && <Spinner />}
                    {!funding && <Image src="/wallet.svg" width="22" height="22" alt="" />}
